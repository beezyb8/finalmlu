...
<body>
    <nav class="nav_bar_sticky">
        ...
        <ul class="nav_cont_list">
            ...
            <li class="navbar_cont">
            <a href="bestpractices.php"><i class="bi bi-briefcase" id="dashicon"></i><br><br><p class="innernav_txt">Your Account<p></a>
            </li>
        </ul>
    </nav>
    <div class="bodycont">
        ...
        <div class="pagelinks">
            <ul class="pagelinks_cont">
                <li class="changecont" id="gennw">
                    <p class="sectiontab">Gereral Networking</p>
                </li><li class="changecont" id="sendemails">
                    <p class="sectiontab">Sending Emails</p>
                </li><li class="changecont" id="compres">
                    <p class="sectiontab">Company Presentations</p>
                </li><li class="changecont" id="behav">
                    <p class="sectiontab">Behavioral Interviews</p>
                </li><li class="changecont" id="techint">
                    <p class="sectiontab">Technical Interviews</p>
                </li><li class="changecont" id="formats">
                    <p class="sectiontab">Formats + Resources</p>
                </li>
            </ul>
        </div>
        <div class="body">
